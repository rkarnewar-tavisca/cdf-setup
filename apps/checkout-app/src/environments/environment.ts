...
export const environment = {
  ...
  pciBaseUrl: 'https://checkout-creditcard-component.s3.amazonaws.com/index.html',
  loggingBaseUrl: 'https://orxe-api.qa.cnxloyalty.com/api/orxe/v1.0/log/',
  nameSpace: 'checkout_orxe3',
  applicationId: '53hly6nbtxl',
  owner: '1116',
  binUrl: 'https://cdhbcs3pv2.execute-api.us-east-1.amazonaws.com/Dev/mock/PurchaseBinValidation/'
};
